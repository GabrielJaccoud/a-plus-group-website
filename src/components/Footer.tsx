        ...
        <div className={styles.grid}>
          ...
          <div className={styles.section}>
            <Link href="/" className={styles.logoLink}>
              ...
              <div className={styles.logoText}>
                <h3 className={styles.logoTitle}>A+ ENGENHARIA</h3>
                <p className={styles.logoSubtitle}>Excelência em Projetos</p>
              </div>
            </Link>
            <p className={styles.description}>
              Mais do que casas, histórias de vida. Construindo o futuro com inovação, propósito e tecnologia financeira.
            </p>
            <div className={styles.socialLinks}>
              ...
              <a href="https://wa.me/5522991017777" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="WhatsApp">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.linkList}>
              ...
              <li><Link href="/obras-realizadas" className={styles.link}>Obras Realizadas</Link></li>
              <li><Link href="/investidores" className={styles.link}>Investidores</Link></li>
              <li><Link href="/credito" className={styles.link}>Soluções de Crédito</Link></li>
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.contactList}>
              <li className={styles.contactItem}>
                ...
                <a href="mailto:amais.eng@gmail.com" className={styles.contactLink}>amais.eng@gmail.com</a>
              </li>
              <li className={styles.contactItem}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                <a href="tel:+5522991017777" className={styles.contactLink}>(22) 99101-7777</a>
              </li>
              <li className={styles.contactItem}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span className={styles.contactText}>Alameda Tenente Célio, 47 – São Marcos, Macaé/RJ</span>
              </li>
            </ul>
          </div>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.qrDescription}>Escaneie o QR Code para falar conosco pelo WhatsApp</p>
            <div className={styles.qrCode}>
              <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://wa.me/5522991017777" alt="QR Code WhatsApp" />
            </div>
          </div>
        </div>

        <div className={styles.copyright}>
          © {new Date().getFullYear()} A+ ENGENHARIA. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
